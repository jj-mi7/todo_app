...
fun Completed(navHostController: NavHostController) {
    ...
    AnimatedVisibility(
        true, modifier = Modifier.fillMaxSize(1f),
        enter = fadeIn(animationSpec = tween(2000)) + expandIn(),
        exit = shrinkOut(animationSpec = tween(2000)) + fadeOut(animationSpec = tween(2000))
    ) {
